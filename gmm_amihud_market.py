...
if __name__=='__main__':
    ...
    x_list= ['amihud_measure_A_volume','amihud_measure_H_volume','amihud_turnover_A','amihud_turnover_H','amihud_constant_A_volume',
                'amihud_constant_H_volume', 'AH_share_size','supply','vol']
    for key in x_list:
    ...
    generate_instruments_list=['discount_y','amihud_measure_AH','amihud_turnover_AH', 'amihud_constant_AH',
    ...
    x_regression_list = ['constant',
                         'amihud_measure_AH',
                         #'amihud_turnover_AH','amihud_constant_AH',
                         'AH_share_size', 'supply', 'vol','csi_hsc',
                         ]
    ...
    instruments_list=[#'amihud_measure_AH',
                      ...
                      'amihud_turnover_AH_diff',
                      #'amihud_constant_AH_diff',
                      'AH_share_size', 'supply', 'vol','csi_hsc','csi_hsc_diff',
