...
if __name__=='__main__':
    ...
    print factors_data_monthly_path
    ...
    #==============Model1===============
    #Generate gmm data
    x_regression_list = ['constant','amihud_measure_AH']
    ...
    instruments_list=['amihud_measure_AH',
                      ...
                      'csi_hsc_diff','AH_share_size_diff', 'supply_diff', 'vol_diff',
                      'discount_y_diff']
    ...
    ah_gmm.summary()
    print 'Observations: %d' %ah_gmm.nobs

    #===============Model2================
    #Generate gmm data
    x_regression_list = ['constant','amihud_turnover_AH']
    y_regression_list=['discount_y']
    instruments_list=['amihud_turnover_AH',
                      'amihud_measure_AH_diff','amihud_turnover_AH_diff','amihud_constant_AH_diff',
                      'csi_hsc_diff','AH_share_size_diff', 'supply_diff', 'vol_diff',
                      'discount_y_diff']
    ...
    #===============Model3================
    #Generate gmm data
    x_regression_list = ['constant','amihud_constant_AH']
    y_regression_list=['discount_y']
    instruments_list=['amihud_constant_AH',
                      'amihud_measure_AH_diff', 'amihud_turnover_AH_diff', 'amihud_constant_AH_diff',
                      'csi_hsc_diff','AH_share_size_diff', 'supply_diff', 'vol_diff',
                      'discount_y_diff']
    ...
    #===============Model4================
    # Generate gmm data
    x_regression_list = ['constant','amihud_measure_AH','amihud_turnover_AH','amihud_constant_AH']
    y_regression_list = ['discount_y']
    instruments_list = ['amihud_measure_AH','amihud_turnover_AH','amihud_constant_AH',
                        'amihud_measure_AH_diff', 'amihud_turnover_AH_diff', 'amihud_constant_AH_diff',
                        'csi_hsc_diff','AH_share_size_diff', 'supply_diff', 'vol_diff',
                        'discount_y_diff'
                        ]
